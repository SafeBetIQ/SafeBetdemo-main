            ...
            <TabsContent value="api-keys" className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Keys authenticate your casino platform when sending data to SafePlay Connect</p>
                </div>
              ...
              {loading ? (
                ...
                <Card className="border-dashed">
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-xs text-muted-foreground mb-4">Create your first key to start sending player data to SafePlay Connect</p>
