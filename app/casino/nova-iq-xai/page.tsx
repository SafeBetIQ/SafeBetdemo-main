...
export default function NovaIQXAIPage() {
  ...
  const sampleReasonStack = {
    ...
    explanationSummary:
      'Multiple high-risk behavioral patterns detected in the last 24 hours, supported by Nova IQ impulsivity assessment. Immediate intervention recommended.',
    triggers24h: [
      { type: 'loss_chasing', count: 3 },
      { type: 'session_escalation', ratio: 2.4 },
    ],
    triggers7d: [{ type: 'spend_volatility', coefficient: 68 }],
    triggers30d: [],
  ...
  const sampleRecommendation = {
    ...
    rationale:
      'Loss-chasing and session escalation patterns detected. Nova IQ behavioral profile indicates high impulsivity requiring immediate intervention. Cooling-off period recommended to restore rational decision-making.',
    alternativeOptions: [
      {
        type: 'soft_message',
        probability: 68,
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Nova IQ XAI Intelligence System</h1>
          ...
          <div className="flex gap-3">
            ...
            <Badge className="bg-sky-100 text-sky-700 border-0">+19.4% Improvement</Badge>
          </div>
        </div>
            ...
            <div className="absolute top-3 right-3 z-10">
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  <p>
                    Full transparency into AI decision-making. Every risk assessment displays the
                    top contributing factors, their percentage weights, and data sources (Nova IQ
                    behavioral scores vs. casino gambling data).
                  </p>
                </TooltipContent>
              </Tooltip>
            </div>
          ...
          <Card className="relative">
            <div className="absolute top-3 right-3 z-10">
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  <p>
                    Percentage of AI-guided interventions that successfully led to positive
                    behavioral changes, such as reduced risk scores, lower spending, or player
          ...
          <Card className="relative">
            <div className="absolute top-3 right-3 z-10">
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  <p>
                    Improvement in prediction accuracy when Nova IQ behavioral assessment data
                    (impulsivity, patience, risk tolerance) is combined with live casino gambling
                    patterns.
                  </p>
                </TooltipContent>
              </Tooltip>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-cyan-600 mb-2">+12.5%</div>
              <p className="text-sm text-gray-600">
        ...
        <Tabs defaultValue="reason-stack" className="space-y-6">
          ...
          <TabsContent value="reason-stack" className="space-y-6">
            <div className="mb-4">
              <h2 className="text-xl font-bold text-gray-900 mb-2">Explainable AI Reason Stack</h2>
              <p className="text-gray-600">
                See exactly why the AI flagged this player, with contributing factors from live
                casino data and Nova IQ behavioral assessments.
              </p>
            </div>
          ...
          <TabsContent value="recommendation" className="space-y-6">
            <div className="mb-4">
              ...
              <p className="text-gray-600">
                AI suggests the intervention type, timing, and provides success probability. Staff
                can accept, override, or defer with full decision logging.
              </p>
            </div>
            <AIInterventionRecommendation {...sampleRecommendation} readOnly />
            <Card className="bg-sky-50 border-sky-200">
              <CardContent className="pt-6">
                <h3 className="font-semibold text-sky-900 mb-2">Decision Support Features</h3>
          ...
          <TabsContent value="outcome" className="space-y-6">
            <div className="mb-4">
              ...
              <p className="text-gray-600">
                Track post-intervention results to measure effectiveness and feed learning back into
                the AI system.
              </p>
            </div>
          ...
          <TabsContent value="learning" className="space-y-6">
            <div className="mb-4">
              ...
              <p className="text-gray-600">
                System-wide AI accuracy improvements, Nova IQ impact, and intervention success
                rates.
              </p>
            </div>
              ...
              <div className="space-y-6">
                {learningMetrics.map((metric) => (
                  <AILearningMetrics
                    key={metric.id}
                    casinoName={
                      metric.casino_id ? 'Casino Performance' : 'Global System Performance'
                    }
        ...
        <Card className="mt-8 border-2 border-slate-200">
          <CardHeader>
            ...
            <CardDescription>
              How Nova IQ XAI works with SafeBet IQ intervention engine
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div className="font-bold text-blue-900 mb-2">1. Data Collection</div>
              ...
              <div className="p-4 bg-cyan-50 rounded-lg border border-cyan-200">
                <div className="font-bold text-cyan-900 mb-2">2. AI Analysis</div>
