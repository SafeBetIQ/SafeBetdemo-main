    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <Button size="lg" className="bg-teal-500 hover:bg-teal-600 text-black font-semibold px-10 py-6 text-base">
                  Request a Report Demo
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/login">
                <Button size="lg" variant="outline" className="border-gray-700 text-gray-300 hover:border-teal-500 hover:text-teal-400 px-10 py-6 text-base">
                  View Live Dashboard
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {REPORT_TYPES.map((report, i) => (
              <Card key={i} className="bg-gray-900/40 border-gray-800 hover:border-teal-500/30 transition-all duration-200 group">
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-3 py-3 border-b border-gray-800 last:border-0">
                  ...
                  <span className="text-teal-400 text-xs w-10 flex-shrink-0">{row.pages}</span>
      ...
      <section className="py-20 px-6 bg-gray-950 border-t border-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button size="lg" className="bg-teal-500 hover:bg-teal-600 text-black font-semibold px-10 py-6">
                Book a Demo
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link href="/features/regulators">
              <Button size="lg" variant="outline" className="border-gray-700 text-gray-300 hover:border-teal-500 hover:text-teal-400 px-10 py-6">
                Regulator Features
