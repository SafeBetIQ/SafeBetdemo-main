...
/*
  # Seed Nova IQ / Wellbeing Game Demo Data — Casinos K through R

  Extends the existing Nova IQ demo data to cover the 8 remaining casinos
  (K, L, M, N, O, P, Q, R) that were missed in the previous seed.

  Creates:
  - 3 campaigns per casino (periodic, post_session, risk_signal)
  - ~30 invitations per casino with realistic status spread
  - Sessions and risk scores for all completed invitations
*/

-- ============================================================
-- 1. CAMPAIGNS for Casinos K–R
-- ============================================================
...
-- ============================================================
-- 2. INVITATIONS + SESSIONS + RISK SCORES for Casinos K–R
-- ============================================================
DO $$
DECLARE
  ...
  FOREACH cid IN ARRAY casino_ids LOOP
    ...
    LOOP
      ...
      VALUES (
        ...
        opened_ts, completed_ts, inv_status, delivery, cid
      );
      ...
      IF inv_status = 'completed' THEN
        ...
        VALUES (
          ...
          dur_sec, 1.0, false, raw_sc, bri, hesitation, consistency,
        ...
        VALUES (
          gen_random_uuid(), pid, cid, sess_id, bri, impulsivity, risk_esc, patience, recovery,
          jsonb_build_object(
