...
//
// This script inserts 100 synthetic South African players into the `players`
// table for local development and demo database seeding.
//
// DO NOT run this against a production Supabase project.
// Live demo data is generated by the casino-simulator edge function instead
// (events are marked is_simulated: true and flow through CasinoDataContext).
//
...
if (process.env.NODE_ENV === 'production') {
  console.error('ERROR: seed-players.ts must not be run in production. Exiting.');
  process.exit(1);
}
