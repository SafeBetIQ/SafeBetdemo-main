...
import { TriangleAlert as AlertTriangle, TrendingDown, TrendingUp, Clock, DollarSign, Target, Activity, Minus, Globe, Calendar, ChartBar as BarChart3 } from 'lucide-react';
import {
  AreaChart,
  Area,
  XAxis,
