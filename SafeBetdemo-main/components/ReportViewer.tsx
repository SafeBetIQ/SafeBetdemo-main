    ...
    return (
      <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 mt-6">
            <Card className="bg-gradient-to-br from-blue-50 to-brand-50 border-2 border-blue-200">
              <CardContent className="p-6">
                ...
                {r.industrySummary.totalPlayers !== undefined && (
                  <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-gray-200">
                    <div className="text-center p-3 bg-white rounded-lg">
                      <div className="text-2xl font-bold text-brand-600">{r.industrySummary.totalPlayers.toLocaleString()}</div>
