    ...
    <div className="space-y-4">
      <Card className="bg-slate-900/80 border-slate-800">
        <CardContent className="p-6 space-y-4">
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-brand-500/10 to-blue-500/10 border border-brand-500/30 rounded-lg">
            <div className="flex items-start gap-3">
              <HelpCircle className="w-5 h-5 text-brand-400 mt-0.5 flex-shrink-0" />
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <Button
                    size="sm"
                    variant="outline"
                    className="border-brand-500/30 hover:bg-brand-500/10 text-brand-400 text-xs"
