      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] md:min-h-[600px] bg-gradient-to-b from-slate-900 to-slate-800 rounded-lg p-4 md:p-8">
        <div className="text-center space-y-4 md:space-y-6 max-w-md">
          <div className="w-16 h-16 md:w-20 md:h-20 mx-auto bg-brand-500/20 rounded-full flex items-center justify-center">
            <svg className="w-8 h-8 md:w-10 md:h-10 text-brand-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {showInstructions && (
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4 md:p-6 max-w-lg mb-4">
          ...
          <button
            ...
            className="w-full bg-brand-600 hover:bg-brand-500 text-white py-2 md:py-2.5 rounded-lg transition-colors text-sm md:text-base"
          >
            Begin Experience
          </button>
        </div>
