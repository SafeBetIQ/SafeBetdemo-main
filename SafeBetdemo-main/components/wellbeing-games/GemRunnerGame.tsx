    ...
    <Card className="bg-gray-900 border-gray-800 overflow-hidden relative">
      {gameState === 'menu' && (
        <div className="bg-gradient-to-br from-black via-gray-900 to-gray-800 p-4 md:p-6 relative overflow-hidden">
          ...
          />
          <motion.div
            className="absolute bottom-20 right-10 w-96 h-96 bg-brand-500/10 rounded-full blur-3xl"
            animate={{
              scale: [1, 1.3, 1],
              opacity: [0.3, 0.6, 0.3],
            }}
          ...
          <div className="max-w-lg mx-auto text-center relative z-10">
            ...
            >
              <Button
                size="lg"
                onClick={startGame}
                className="w-full sm:w-auto bg-gradient-to-r from-brand-400 to-brand-500 hover:from-brand-500 hover:to-brand-600 text-black font-bold text-base md:text-lg px-6 py-5 shadow-2xl transform hover:scale-105 transition-all"
              >
          ...
          <div className="max-w-lg mx-auto text-center relative z-10 w-full">
            ...
            >
              <Button
                size="lg"
                onClick={resetGame}
                className="w-full sm:w-auto bg-gradient-to-r from-brand-400 to-brand-500 hover:from-brand-500 hover:to-brand-600 text-black font-bold text-base md:text-lg px-6 py-5 shadow-2xl"
              >
