        ...
        >
          <Card className="bg-slate-900/80 border-slate-800 backdrop-blur shadow-2xl">
            <CardContent className="p-6 md:p-12 space-y-6 text-center">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-brand-500 rounded-full blur-xl opacity-50 animate-pulse" />
                <div className="relative w-full h-full bg-gradient-to-r from-emerald-500 to-brand-500 rounded-full flex items-center justify-center">
              ...
              <div className="bg-slate-800/50 rounded-xl p-4 md:p-6 space-y-4 text-left border border-slate-700/50">
                ...
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-brand-500/10 rounded-lg">
                    <Timer className="w-5 h-5 text-brand-400 flex-shrink-0" />
                  </div>
                  <div className="flex-1">
              ...
              <Button
                onClick={startGame}
                size="lg"
                className="w-full bg-gradient-to-r from-emerald-500 to-brand-500 hover:from-emerald-600 hover:to-brand-600 text-white font-semibold text-lg py-6 shadow-lg shadow-emerald-500/25"
              >
                Start Playing
              </Button>
              ...
              {!showConsequence ? (
                ...
                >
                  ...
                  <Button
                    ...
                    size="lg"
                    className="bg-gradient-to-r from-emerald-500 to-brand-500 hover:from-emerald-600 hover:to-brand-600"
                  >
          ...
          <Card className="bg-slate-900/80 border-slate-800 backdrop-blur shadow-2xl">
            <CardContent className="p-8 space-y-6 text-center">
              <div className="relative w-20 h-20 mx-auto">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-brand-500 rounded-full blur-xl opacity-50" />
                <div className="relative w-full h-full bg-gradient-to-r from-blue-500 to-brand-500 rounded-full flex items-center justify-center">
              ...
              <div className="space-y-3">
                <Button
                  onClick={togglePause}
                  size="lg"
                  className="w-full bg-gradient-to-r from-emerald-500 to-brand-500 hover:from-emerald-600 hover:to-brand-600"
                >
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-semibold bg-gradient-to-r from-emerald-400 to-brand-400 bg-clip-text text-transparent">
                    Score: {score}
                  </span>
                </div>
              </div>
        ...
        <Card className="bg-slate-900/80 border-slate-800 backdrop-blur shadow-2xl overflow-hidden">
          <CardContent id="results-container" className="p-0 space-y-0">
              ...
              >
                ...
                <div className="space-y-2">
                  {educationalResources.slice(0, 3).map((resource, index) => (
                    <div
                      key={index}
                      className="p-4 bg-slate-800/50 border border-slate-700 rounded-lg hover:border-brand-500/50 transition-colors"
                    >
                      <div className="flex items-start gap-3">
                        <div className="p-2 bg-brand-500/10 rounded-lg">
                          {resource.resource_type === 'helpline' ? <Phone className="w-4 h-4 text-brand-400" /> :
                           resource.resource_type === 'article' ? <BookOpen className="w-4 h-4 text-brand-400" /> :
            ...
            <div className="text-center pt-4 border-t border-slate-800">
              ...
              <p className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-400 to-brand-400 bg-clip-text text-transparent">
                {score} points
              </p>
              {comboStreak >= 3 && (
            ...
            {demoMode && (
              <div className="bg-gradient-to-r from-emerald-500/10 to-brand-500/10 border border-emerald-500/30 rounded-lg p-4 text-center">
