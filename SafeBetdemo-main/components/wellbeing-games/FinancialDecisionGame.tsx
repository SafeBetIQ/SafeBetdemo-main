        ...
        <Card className="bg-slate-900 border-slate-700">
          <CardContent className="p-4 md:p-6 space-y-4 md:space-y-6">
            <div className="text-center space-y-3 md:space-y-4">
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto bg-brand-500/20 rounded-full flex items-center justify-center">
                <Target className="w-8 h-8 md:w-10 md:h-10 text-brand-400" />
              </div>
            ...
            <Button
              onClick={startGame}
              className="w-full bg-brand-600 hover:bg-brand-500 text-white text-base md:text-lg px-6 py-5"
            >
              Begin Assessment
            </Button>
          </CardContent>
      ...
      <div className="max-w-lg mx-auto">
        <Card className="bg-slate-900 border-slate-700">
          <CardContent className="p-4 md:p-6 text-center space-y-4 md:space-y-6">
            <div className="w-16 h-16 md:w-20 md:h-20 mx-auto bg-brand-500/20 rounded-full flex items-center justify-center">
              <CheckCircle className="w-8 h-8 md:w-10 md:h-10 text-brand-400" />
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-3 pt-2 md:pt-4">
              <div className="bg-slate-800/50 rounded-lg p-3">
                <div className="text-xl md:text-2xl font-bold text-brand-400">{riskChoices.high}</div>
                <div className="text-xs text-slate-400">High Risk</div>
              </div>
              <div className="bg-slate-800/50 rounded-lg p-3">
                <div className="text-xl md:text-2xl font-bold text-brand-400">{riskChoices.medium}</div>
                <div className="text-xs text-slate-400">Medium Risk</div>
              </div>
              <div className="bg-slate-800/50 rounded-lg p-3">
                <div className="text-xl md:text-2xl font-bold text-brand-400">{riskChoices.low}</div>
      ...
      <Card className="bg-slate-900 border-slate-700">
        <CardContent className="p-4 md:p-6">
          <div className="space-y-4">
            <div>
              <div className="inline-block px-2 py-1 bg-brand-500/10 border border-brand-500/30 rounded-full text-xs text-brand-400 mb-2">
            ...
            {showFeedback && lastChoice ? (
              <div className="space-y-3 animate-in fade-in duration-300">
                <div className={`p-3 rounded-lg border ${
                  ...
                  lastChoice.risk === 'medium' ? 'bg-brand-500/10 border-brand-500/30' :
                  ...
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-lg border-2 transition-all hover:scale-[1.01] ${
                      option.risk === 'high'
                        ...
                        : option.risk === 'medium'
                        ? 'border-brand-500/30 hover:border-brand-500 hover:bg-brand-500/10'
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        <span className={`text-xs px-2 py-0.5 rounded ${
                          ...
                          option.risk === 'medium' ? 'bg-brand-500/20 text-brand-300' :
