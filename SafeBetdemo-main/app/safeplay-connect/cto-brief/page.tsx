  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-brand-400 to-brand-500 text-transparent bg-clip-text">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-r from-brand-400/10 to-brand-500/10 border border-brand-400/20 rounded-lg p-8">
