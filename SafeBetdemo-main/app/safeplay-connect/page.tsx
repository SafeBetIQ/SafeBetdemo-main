    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <motion.div
            className="absolute bottom-10 left-10 w-80 h-80 bg-brand-500/8 rounded-full blur-3xl"
              ...
              <Card className="bg-gray-950 border-gray-800 overflow-hidden">
                <CardContent className="p-0">
                  ...
                  <div className="p-5 font-mono text-xs leading-relaxed">
                    ...
                    <div className="text-gray-400 pl-4">{'"risk_level"'}: <span className="text-brand-400">{'"high"'}</span>,</div>
