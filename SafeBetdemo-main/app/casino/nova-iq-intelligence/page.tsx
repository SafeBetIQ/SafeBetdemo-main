      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-brand-500 rounded-2xl flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="relative">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-brand-600 mb-2">+12.5%</div>
              <p className="text-sm text-gray-600">
        ...
        <Card className="mt-8 border-2 border-slate-200">
          <CardHeader>
            ...
            <CardDescription>
              How Nova IQ Intelligence works with SafeBet IQ intervention engine
            </CardDescription>
          </CardHeader>
          <CardContent>
