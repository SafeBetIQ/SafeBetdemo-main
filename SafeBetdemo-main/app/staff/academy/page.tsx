    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 md:space-x-3">
              <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-brand-400 to-brand-500 rounded-xl flex items-center justify-center shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8">
          <Card className="bg-gradient-to-br from-brand-50 to-brand-50 border-brand-200 shadow-md">
                        ...
                        <CardContent className="p-4 md:p-6">
                          ...
                          <div className="mb-4">
                            ...
                            <div className="w-full bg-gray-200 rounded-full h-2.5">
                              <div
                                className="bg-gradient-to-r from-brand-400 to-brand-500 h-2.5 rounded-full transition-all"
                          ...
                          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                            ...
                            <Link href={`/staff/academy/course/${enrollment.module.id}`} className="w-full sm:w-auto">
                              <Button className="bg-gradient-to-r from-brand-400 to-brand-500 hover:from-brand-500 hover:to-brand-600 text-white text-sm w-full sm:w-auto">
