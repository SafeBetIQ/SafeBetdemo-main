                  ...
                  {!editMode ? (
                    ...
                    <div className="hidden md:flex gap-2">
                      ...
                      <Button
                        ...
                        disabled={savingProfile}
                        className="bg-gradient-to-r from-brand-400 to-brand-500 hover:from-brand-500 hover:to-brand-600"
                      >
                ...
                {!editMode ? (
                  ...
                  <div className="md:hidden mt-4 flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={handleSaveProfile}
                      disabled={savingProfile}
                      className="flex-1 bg-gradient-to-r from-brand-400 to-brand-500 hover:from-brand-500 hover:to-brand-600"
                    >
                      <Save className="h-4 w-4 mr-2" />
              ...
              <Card className="mt-6">
                ...
                <CardContent>
                  <form onSubmit={handleAdminPasswordReset}>
                    ...
                    <Button
                      type="submit"
                      className="w-full mt-6 bg-gradient-to-r from-brand-400 to-brand-500 hover:from-brand-500 hover:to-brand-600"
                      disabled={resettingPassword}
                    >
              ...
              <CardContent>
                <form onSubmit={handlePasswordChange} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-brand-400 to-brand-500 hover:from-brand-500 hover:to-brand-600"
                  >
