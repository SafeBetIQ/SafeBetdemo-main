...
const RISK_FACTORS = [
  ...
  { label: 'Behavioral Flags', value: 13, max: 15, color: 'bg-brand-500' },
];
...
export default function CasinosPage() {
  ...
  const riskColor =
    ...
    riskScore > 65 ? { text: 'text-brand-400', bg: 'bg-brand-500/10', border: 'border-orange-500/30', label: 'HIGH RISK' } :
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-brand-500/8 rounded-full blur-[100px]" />
            ...
            >
              <Card className="bg-gray-950/80 border-gray-800 backdrop-blur-sm">
                <CardContent className="p-6">
                  ...
                  <motion.div
                    className="p-4 bg-orange-500/8 border border-brand-500/20 rounded-lg"
              ...
              <Card className="bg-gradient-to-br from-gray-900 to-black border-gray-800">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge className="bg-brand-500/10 text-brand-400 border-0 text-xs">XAI Active</Badge>
                  </div>
                  <div className="space-y-3">
                    {[
                      { signal: 'Bet increase detected', weight: 'High', severity: 'text-red-400', bar: 'bg-red-500', pct: 88 },
                      { signal: 'Session > 4 hours', weight: 'High', severity: 'text-brand-400', bar: 'bg-orange-500', pct: 75 },
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      { label: 'At-Risk', pct: 24, color: 'text-brand-400', bg: 'bg-orange-500' },
