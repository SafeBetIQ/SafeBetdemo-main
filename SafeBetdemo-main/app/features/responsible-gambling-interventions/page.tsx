        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
              ...
              {[
                { time: '14:32:07', player: 'PL-00491', channel: 'WhatsApp', trigger: 'Risk Score 84', status: 'Delivered', statusColor: 'text-brand-400' },
                ...
                { time: '14:22:04', player: 'PL-03341', channel: 'WhatsApp', trigger: 'Deposit x3', status: 'Delivered', statusColor: 'text-brand-400' },
