        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
              ...
              {[
                { operator: 'Apex Gaming Group', score: 94, interventions: '2,841', exclusions: 312, status: 'Compliant', color: 'text-brand-400' },
                { operator: 'Highveld Gaming Group', score: 91, interventions: '1,654', exclusions: 198, status: 'Compliant', color: 'text-brand-400' },
                { operator: 'Crown & Sceptre Group', score: 88, interventions: '987', exclusions: 134, status: 'Compliant', color: 'text-brand-400' },
                { operator: 'Goldfields Gaming Group', score: 76, interventions: '445', exclusions: 87, status: 'Review', color: 'text-yellow-400' },
                { operator: 'Coastline Casino & Entertainment', score: 62, interventions: '198', exclusions: 41, status: 'Alert', color: 'text-brand-400' },
              ].map((row, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-4">
              {[
                ...
                { label: 'Intervention Response Rate', value: 87, color: 'bg-brand-400' },
