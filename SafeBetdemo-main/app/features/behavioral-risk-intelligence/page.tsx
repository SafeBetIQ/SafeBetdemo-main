...
const riskTimeline = [
  { time: '09:00', score: 22, label: 'Low Risk', color: 'text-brand-400' },
  { time: '11:30', score: 35, label: 'Normal', color: 'text-brand-400' },
  { time: '14:00', score: 48, label: 'Elevated', color: 'text-yellow-400' },
  { time: '16:45', score: 67, label: 'High', color: 'text-brand-400' },
...
export default function BehavioralRiskIntelligencePage() {
  ...
  const getRiskColor = (score: number) => {
    if (score < 30) return 'text-brand-400';
  ...
  const getRiskBg = (score: number) => {
    if (score < 30) return 'bg-green-400/20 border-brand-400/30';
    if (score < 50) return 'bg-yellow-400/20 border-yellow-400/30';
    if (score < 70) return 'bg-orange-400/20 border-brand-400/30';
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <motion.div
            className="absolute bottom-20 right-10 w-80 h-80 bg-brand-500/8 rounded-full blur-3xl"
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-800">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-orange-400/20 text-brand-400 border-brand-400/30">
