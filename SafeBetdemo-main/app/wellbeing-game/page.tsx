        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              Understand your gaming approach through engaging scenarios that measure decision patterns.
            </motion.p>
            ...
            >
              ...
              <Button
                ...
                variant="outline"
                asChild
                className="border-gray-700 hover:border-brand-400 hover:bg-brand-400/10 text-white"
              >
                <Link href="/contact">
            ...
            >
              <Card className="bg-slate-900/50 border-slate-800 hover:border-brand-400/50 transition-all">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-400">
                    Transparent scoring with clear reasoning. Built for regulator scrutiny and audit trails.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                asChild
                className="bg-brand-500 hover:bg-brand-600 text-black font-semibold px-8"
              >
                <Link href="/contact">
                  <MessageSquare className="mr-2 h-5 w-5" />
                  Book a Demo
              ...
              <Button
                size="lg"
                asChild
                className="bg-slate-700 hover:bg-slate-600 text-white border border-slate-600 hover:border-brand-400 font-semibold px-8"
              >
